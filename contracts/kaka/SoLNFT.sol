...
contract StatueOfLiberty is ERC721Enumerable, Ownable {
    ...
    constructor(string memory baseURI) ERC721("Statue of Liberty", "Statue of Liberty") {
        setBaseURI(baseURI);
    }
    ...
    function divest(address token_, address payee_, uint value_) external onlyOwner {
      if (token_ == address(0)) {
          ...
          ERC20(token_).transfer(payee_, value_);
      }
    }
